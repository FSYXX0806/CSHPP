...
class TrainDataPackage:
    def __init__(self, root="/home/compressedsensing/home/ld/code/transcs_cl/zuixin (副本)/dataset", transform=None, packaged=True):  # todo ./dataset
    ...
    def generate(self):
        paths = [
            os.path.join(self.root, "/home/compressedsensing/home/ld/code/transcs_cl/zuixin (副本)/dataset/train/BSDS500/train/"),
            os.path.join(self.root, "/home/compressedsensing/home/ld/code/transcs_cl/zuixin (副本)/dataset/train/BSDS500/test/"),
            os.path.join(self.root, "/home/compressedsensing/home/ld/code/transcs_cl/zuixin (副本)/dataset/train/BSDS500/val/"),
        ]
        patches_list = []
